...
class Issue(Base):
    ...
    accessibility_inspection_id: Mapped[int | None] = mapped_column(
        ForeignKey("accessibility_inspections.id", ondelete="SET NULL"), nullable=True,
        index=True, comment="关联无障碍专项检查",
    )
    ...
    accessibility_inspection: Mapped["AccessibilityInspection | None"] = relationship(  # noqa: F821
