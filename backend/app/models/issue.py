...
class Issue(Base):
    ...
    accessibility_check_id: Mapped[int | None] = mapped_column(
        ForeignKey("accessibility_checks.id", ondelete="SET NULL"), nullable=True, index=True,
        comment="关联无障碍专项检查",
    )
    ...
    accessibility_check: Mapped["AccessibilityCheck | None"] = relationship(  # noqa: F821
